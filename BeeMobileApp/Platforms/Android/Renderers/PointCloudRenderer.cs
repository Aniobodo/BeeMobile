    ...
    public class PointCloudRenderer : IDisposable
    {
        ...
        public void CreateOnGlThread(Context context)
        {
            try
            {
                ...
                int vertexShader = ShaderUtil.LoadGLShader(TAG, context,
                    GLES20.GlVertexShader, _Microsoft.Android.Resource.Designer.ResourceConstant.Raw.point_cloud_vertex);
                int passthroughShader = ShaderUtil.LoadGLShader(TAG, context,
                    GLES20.GlFragmentShader, _Microsoft.Android.Resource.Designer.ResourceConstant.Raw.passthrough_fragment);
        ...
        public void Draw(Pose pose, float[] cameraView, float[] cameraPerspective)
        {
            try
            {
                ...
                GLES20.GlBindBuffer(GLES20.GlArrayBuffer, mVbo);
                GLES20.GlVertexAttribPointer(mPositionAttribute, 4, GLES20.GlFloat, false, BYTES_PER_POINT, 0);
        ...
        public void Dispose(bool isdisposing)
        {
            ...
            if (mLastPointCloud != null) mLastPointCloud.Dispose();
