...
{
    public class DisplayRotationHelper : Java.Lang.Object, DisplayManager.IDisplayListener, IDisposable
    {
        ...
        protected override void Dispose(bool isdisposing)
        {
            ...
            //if (mContext != null) mContext.Dispose(); //Not working (maybe disposed internally)
            if (mDisplay != null) mDisplay.Dispose();
            isDisposed = true;
        }
    }
}